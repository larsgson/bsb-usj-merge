export const before = {
  ...
  content: [
    ...
    { type: "para", marker: "s1", content: ["The Return to Bethlehem"] },
    {
      type: "para",
      marker: "p",
      content: [
    ...
    { type: "para", marker: "s1", content: ["Ruth’s Redemption Assured"] },
    {
      type: "para",
      marker: "p",
      content: [
    ...
    { type: "para", marker: "s1", content: ["Boaz Redeems Ruth"] },
    {
      type: "para",
      marker: "p",
      content: [
    ...
    { type: "para", marker: "s1", content: ["Boaz Marries Ruth"] },
    {
      type: "para",
      marker: "p",
      content: [
    ...
    { type: "para", marker: "li1", content: ["Boaz was the father of Obed,"] },
    {
      type: "para",
      marker: "li1",
      content: [
